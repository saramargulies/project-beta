...
from .views import api_list_autovo, api_list_techs, api_list_appts, api_delete_tech, api_finish_appt, api_cancel_appt,
...
urlpatterns = [
    ...
    path("appointments/:id/cancel", api_can, name="api_list_appts"),

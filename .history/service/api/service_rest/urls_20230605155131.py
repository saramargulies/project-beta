...
urlpatterns = [
    ...
    path("appointments/:id/cancel", api_cancel_appt, name="api_cancel_appt"),
    path("appointments/:id/finish", api_finish_appt, name="api_finish_appt"),
    path("appointments/:id/finish", api_delete_appt, name="api_finish_appt"),
]

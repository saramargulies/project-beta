          ...
          <div className="card shadow">
            <div className="card-body">
              <form onSubmit={handleSubmit} id="class-attendance-form">
                ...
                <div className="mb-3">
                  <input onChange={handleVinChange} value={vin} name="vin" id="vin" className="form-control" required></input>
                </div>
                <div className="row">
                  <div className="col">
                    <div className="form-floating mb-3">
                      <input onChange={handleCustomerChange} value={customer} required placeholder="Cust" type="datetime-local" id="starts" name="starts" className="form-control"></input>

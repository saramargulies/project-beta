            ...
            <div className="card-body">
              <form onSubmit={handleSubmit} id="class-attendance-form">
                ...
                <div className="row">
                  ...
                  <div className="col">
                    <div className="form-floating mb-3">
                      <input onChange={handleEndsChange} value={date} required placeholder="Ends" type="datetime-local" id="ends" name="ends" className="form-control"></input>

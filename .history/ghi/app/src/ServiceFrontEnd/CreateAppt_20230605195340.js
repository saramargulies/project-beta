...
function CreateAppt(props) {
  ...
  const [customer, setStarts] = useState('')
                ...
                <div className="row">
                  <div className="col">
                    <div className="form-floating mb-3">
                      <input onChange={handleStartsChange} value={customer} required placeholder="Starts" type="datetime-local" id="starts" name="starts" className="form-control"></input>

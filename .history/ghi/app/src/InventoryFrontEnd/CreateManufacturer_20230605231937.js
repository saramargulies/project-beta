          ...
          <div className="card shadow">
            <div className="card-body">
              <form className={formStyle} onSubmit={handleSubmit}  id="create-tech-form">
                ...
                <div className="mb-3">
                  <input className="form-control" placeholder="First name" type="text" onChange={handleManufacturerChange} value={manufacturer} name="firstName" id="firstName" required></input>
                </div>
                <div className="mb-3">

          ...
          <div className="card shadow">
            <div className="card-body">
              <form onSubmit={handleSubmit}  id="create-tech-form">
                ...
                <div className="mb-3">
                  <input className="form-control" placeholder="Name of manufacturer" type="text" onChange={handleManufacturerChange} value={manufacturer} name="manufacturer" id="firstName" required></input>
                </div>
